 ...
 * CSS class that is referenced in our HTML code) but in addition we need to regster the JavaScript animation on the module. By making use of the
 * `module.animation()` module function we can regster the ainmation.
 *
