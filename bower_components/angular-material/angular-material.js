 ...
 * To use icon sets, developers are required to pre-regster the sets using the `$mdIconProvider` service.
...
"use strict";
  ...
  /**
    ...
    *
    * @description
    * `$mdIconProvider` is used only to regster icon IDs with URLs. These configuration features allow
    ...
    *
    * @param {string} id Icon name/id used to regster the icon
    ...
    *
    * @param {string} id Icon name/id used to regster the iconset
    * @param {string} url specifies the external location for the data file. Used internally by `$http` to load the
    * data or as part of the lookup in `$templateCache` if pre-loading was configured.
...
function MdSticky($document, $mdConstant, $compile, $$rAF, $mdUtil) {
  ...
  /**
   * Registers an element as sticky, used internally by directives to regster themselves
   */
