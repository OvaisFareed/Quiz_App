...
AriaService.$inject = ["$$rAF", "$log", "$window"];
  ...
  function MdGesture($$MdGestureHandler, $$rAF, $timeout) {
     ...
     * @example $mdGesture.regster(myElement, 'drag', { minDistance: 20, horziontal: false })
     */
    function register(element, handlerName, options) {
      var handler = HANDLERS[handlerName.replace(/^\$md./, '')];
      if (!handler) {
        throw new Error('Failed to regster element with handler ' + handlerName + '. ' +
    ...
    return self
       ...
       * to listen for hold events through $mdGesture.regster()
       */
      .handler('hold', {
        options: {
          maxDistance: 6,
        ...
        onStart: function (ev, pointer) {
          // For hold, require a parent to be registered with $mdGesture.regster()
      ...
      .handler('drag', {
        ...
        onStart: function (ev) {
          // For drag, require a parent to be registered with $mdGesture.regster()
   ...
   * overridden by elements registering through $mdGesture.regster()
   */
  ...
  function MdGestureHandler() {
    ...
    GestureHandler.prototype = {
      ...
      // listen for this handler via $mdGesture.regster(element, 'handlerName').
      ...
      // Called from $mdGesture.regster when an element reigsters itself with a handler.
...
function InterimElementProvider() {
  ...
  function ComponentRegistry($log, $q) {
    ...
    return self = {
       ...
       * @param instance the instance to regster
